...
const NEP: AddEthereumChainParameter['nativeCurrency'] = {
  name: 'Neptune Mutual Token',
  symbol: 'NEP',
  decimals: 18,
}
...
export const CHAINS: { [chainId: number]: BasicChainInformation | ExtendedChainInformation } = {
  ...
  56:{
    urls: [ `https://bsc-dataseed.binance.org/`] as string[],
    name: 'Smart Chain',
    nativeCurrency: BNB,
    blockExplorerUrls: ['https://bscscan.com'],
  },
  97:{
    urls: [`https://data-seed-prebsc-1-s1.binance.org:8545/`] as string[],
